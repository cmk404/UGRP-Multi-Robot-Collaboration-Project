...
CASES=[('v17',224,225),('v17',226,227),('v17',237,238),('v17',317,318),('v17',323,324),('v17',537,538),('v17',538,539),('v17',540,541)]
...
def evaluate(c,oldpoly,newpoly,endpoint,shape):
 ...
 beam_tangent=endpoint-newpoly.mean(axis=0); beam_tangent/=np.linalg.norm(beam_tangent)
...
Path('/tmp/v17_sweep_failure_diag.json').write_text(json.dumps(reports,indent=2)); cv2.imwrite('/tmp/v17_sweep_failure_diag.jpg',np.vstack(viewrows))
