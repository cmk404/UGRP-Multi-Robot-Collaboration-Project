...
def main():
    ...
    record={'source_sha':sha,'noslip_iterations':args.noslip_iterations,'vision_mode':'robust','grasp_spacing':'visual','close_pulse':args.close_pulse,'baseline_source_sha':'a1a6f3353a4c5b378f611267bd43c5820f776917','impratio':args.impratio,'budget_per_trial':750,'wall_timeout_per_trial_s':600,
    ...
    for e in catalog['entries']:
        ...
        command=[str(args.mjpython.resolve()),str(ROOT/'scripts/run_pair_navigation.py'),
                 ...
                 '--budget','750','--impratio',str(args.impratio),'--vision-mode','robust','--grasp-spacing','visual','--close-pulse',str(args.close_pulse),'--noslip-iterations',str(args.noslip_iterations)]
