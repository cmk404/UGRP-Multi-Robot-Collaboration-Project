...
- **[로컬 시뮬레이션 · CLI/Python API](docs/local_simulation.md) · [환경·제어기·action 확장](docs/simulation_extensions.md)** — 기존 연구 장면·작동 모드 선택, 터미널 수동/자연어 명령과 MuJoCo 기본 창 · [구성 검토](docs/simulation_inventory.md)
