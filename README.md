...
**2026-09-16 3대 연결: 세 로봇의 계획 승인 → R1/R3 운반 + R2 목적 구역 관찰.**
실제 모델 정상·준비 지연·운반 보고 단절 세 조건 모두 운반·내려놓기·해제 성공.
지원 운반 조합은 R1/R3로 고정이며, 모델은 계획 수락/거절과 R2 관찰 시점을 결정한다.
R2는 정지 관찰하며 별도 화물 운반·세 대 파지·자유로운 역할/경로 계획은 후속 범위다.
[구성·실행 방법](docs/three_robot_e2e.md) · [전체 결과·실패 기록·영상](experiments/three-robot-e2e-20260916/README.md).
