"""Stage 2c (door v3) test scenario generator: same ranges and filters as gen_stage2b_seeds.py,
rng 20260930, seeds 831-838 (fresh; 831-836 main arms, 837-838 experimenter open-at-lift arm)."""
import json
import sys
