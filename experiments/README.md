...
- [2026-09-25 동적 협업 실패 결정 확인](2026-09-25-dynamic-team-recovery/README.md): 실패 주입 8회(v51 E1–E4, v56 V1–V4). 결정 대화는 모두 선택지 안에서 끝남. 두 화물 전체 성공은 접근 실패 뒤 재시도(E1·V1)만. v56이 추적 유실·빔 포기 뒤 상자 대기를 고쳤고, 짧은 후진 두 건은 v58(미검증).
