...
**2026-09-16 확장 검증: 출발 배치 19종에서 로컬 15/19·LLM 15/19 성공.**
거리 30–70 cm, 방향 ±10°, 좌우 ±6 cm의 단독·혼합 배치를 총 38회 실행했다.
실패 4배치는 모두 파지 전 영상 정렬에서 중단됐다. 비스듬한 먼 거리 전진으로
옆 편차가 누적되어 근거리 모델의 지원 범위를 벗어나는 것이 현재 병목이다.
[전체 배치 결과·성공/실패 영상·후속 수정 범위](experiments/research-e2e-varied-start-20260916/README.md).
