"""Run robust transport terrain trials sequentially within an owned UGRP session."""
...
def main():
    ...
    record={'source_sha':sha,'vision_mode':'robust','baseline_source_sha':'f4da89ec53fed15c9efcea2e8bee19b99de31dfc','impratio':10,'budget_per_trial':750,'wall_timeout_per_trial_s':600,
    ...
    for e in catalog['entries']:
        ...
        command=[str(args.mjpython.resolve()),str(ROOT/'scripts/run_pair_navigation.py'),
                 ...
                 '--budget','750','--impratio','10','--vision-mode','robust']
