...
- [2026-09-25 목적지 선택 + 지도 A* 이동](2026-09-25-map-goto-navigation/README.md): `--navigation planned`(재생 v55, main 병합 뒤 v57로 재등록). 저장 계획 재생 open/seed11에서 A* 2/2·기존 경로 2/2 성공(조건당 1회), 상자 먼저 운반 48.3→26.4 SIM초. 후보 v48 재생 2회 실패(카메라 직하 가림, 서쪽 진입 시차 방출, park 진동)와 수정 기록. 실제 LLM 실행·다른 지도는 미검증.
