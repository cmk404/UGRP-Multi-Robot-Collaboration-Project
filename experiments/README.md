...
- [2026-09-23 공통 RGB 물리 완주 복구](2026-09-23-rgb-common-physical-recovery/README.md) — v1~v6 개발 후보를 같은 seed11에서 분리 재생; 단독 상자 대상은 v3~v6 성공, 공동 빔은 v6에서 역할 배정 교정 후 접근 횟수 제한으로 파지 전 중단. 전체 임무·통신 효과는 미입증.
