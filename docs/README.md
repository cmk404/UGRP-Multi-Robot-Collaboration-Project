...
| 구역 파이프라인 현황·설계 제안 | [E2E 현황(2026-09-25)](e2e_status_20260925.md), [설계 제안(Codex, docs/design/)](design/2026-09-25-zone-team-carry-codex.md) | 구역 팀 운반·미등록 장애물·한국어 대화 단계별 완료/진행/미착수 확인 |
