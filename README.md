...
**2026-09-17 공동 출하 연구 환경: 하나의 목표 → 자유로운 역할/경로 합의 → 로봇별 작업 목록.**
픽업·공유 통로·대기 공간·출하 구역을 실제 물리 환경으로 구성하고 다섯 조건의 로딩/이동 진단을 확인했다.
기본/예상 밖 장애물 두 조건에서 실제 세 LLM의 합의와 프로그램 생성을 검증했다.
**새 지형의 물리 운반 E2E는 실행기 연결 전**이며 아래 고정 역할 운반 성공과 구분한다.
[환경 구성·실행](docs/research_dispatch_arena.md) · [실제 장면·카메라 뷰어](experiments/research-dispatch-arena-20260917/index.html) · [검증·제외 기록](experiments/research-dispatch-arena-20260917/README.md).
