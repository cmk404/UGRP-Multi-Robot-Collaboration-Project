...
공동 운반에서는 현재 영상 분석 중 다음 RGB 묶음을 하나만 미리 촬영·처리한다. 판단 작업은 하나씩 순서대로 적용하고, 선행 촬영된 영상도 실제 촬영 시각으로 유효기간을 검사한다. 대기 중에는 자원 잠금을 유지하며, 기존 부착 검사에 통과한 자기 영상의 연속 비교 상태만 갱신한다. 오래된 기준 영상을 새 영상처럼 취급하거나 판정 기준을 낮추지 않는다.
