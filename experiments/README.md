...
- [2026-09-25 넓은 구역 경기장](2026-09-25-zone-wide-arena/README.md): `zones/zone_wide` 6.45 × 4.6 m, TOP 4대. 규칙 응답 3/3(`bc4a784`), 실LLM ZW1 4/4 목표 달성(`e4ccaf6`, 교사 실행기). 호출·토큰은 plan_first가 적었다(9·10 vs 17·14). 호스트가 내려놓는 중인 상자를 두 번 세는 결함을 발견했고 아직 고치지 않았다. `zone_open` v2는 바이트 그대로 유지.
