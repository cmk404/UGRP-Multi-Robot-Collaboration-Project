...
[검증 기록](../experiments/2026-09-20-multi-object-scenes/README.md): 최종 12/12 정적 후보,
관련 25개·전체 회귀 1,090개 테스트 통과. 90도 회전 probe는 44작업 중 14개만 양쪽 통과해
이번 평행 이동 후보의 범위와 구분했다. 이전 배치의 실패와 접근 검사 보완도 기록했다.
...
후속 [RGB 식별·단계 실행 파일럿](multi_object_execution.md)을 추가했다. 초기 영상/자세 변화 진단과
실행 어댑터는 확인했으나 실제 5작업 완료는 아직 0/5다. 다음은 목표 ID를 기존 RGB 접근·파지 정책에 연결하는 것이다.
