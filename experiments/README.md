...
- [2026-09-23 공통 RGB 물리 완주 복구](2026-09-23-rgb-common-physical-recovery/README.md) — v1~v7 개발 후보를 같은 seed11에서 분리 재생; 단독 상자 대상은 v3~v7 성공, 공동 빔은 v7에서 접근을 마치고 회전 영상 판독에서 파지 전 중단. 전체 임무·통신 효과는 미입증.
