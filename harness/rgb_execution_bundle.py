...
RUNNABLE_ID = "rgb-standard-dispatch-v8"
RETIRED_IDS = frozenset({"rgb-adapter-legacy-v1", "rgb-standard-dispatch-v2",
                         "rgb-standard-dispatch-v3", "rgb-standard-dispatch-v4", "rgb-standard-dispatch-v5", "rgb-standard-dispatch-v6", "rgb-standard-dispatch-v7"})
