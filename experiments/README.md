...
- [2026-09-22 ACT 영상 처리 속도](2026-09-22-act-render-speed/README.md) — 불필요한 카메라 렌더링 생략; 8쌍 입력 바이트 동일, 관측 처리 1.586배. 전체 운반 검증은 별도.
- [2026-09-22 ACT 방출 연결·기준선 재검증](2026-09-22-act-release-revalidation/README.md) — RGB 추적 연속성, 공통 판단 예산과 2400초 한도 복원; 물리 재검증은 결과 회수 후 판단.
