...
- [2026-09-25 넓은 구역 경기장](2026-09-25-zone-wide-arena/README.md): `zones/zone_wide` 6.45 × 4.6 m, TOP 4대. 규칙 응답(LLM 0회)으로 교사 실행기 G5 dynamic, G8 plan_first/dynamic 3/3 목표 달성(`bc4a784`). `zone_open` v2는 바이트 그대로 유지. LLM 코호트는 미실행.
