...
> 아래 스킬 연결 상태·수치는 초기 통합 실험 기준이다. 목적지 B·장애물 후속 6조건 검증과 `local_contact_fine` 재현 설정은 [복구 보고서](../experiments/dispatch-adaptive-recovery-20260917/README.md), 전체 진입점은 [현재 상태](current_status.md)를 따른다.
