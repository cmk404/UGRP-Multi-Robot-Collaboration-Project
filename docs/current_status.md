...
시뮬레이션·렌더링·학습·평가의 기본 실행 대상은 Colab CLI다. [CLI 실행·결과 회수 안내](colab_simulation.md)를 따른다. [실제 CLI CPU 데모와 결과 회수](../experiments/2026-09-21-colab-cli-smoke/README.md)를 확인했다. 기존 실험 전체를 Colab에서 재검증했다는 뜻은 아니다. 실물 연결은 로컬에서 수행한다.
